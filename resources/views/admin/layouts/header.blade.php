...
<div class="navbar navbar-fixed-top" id="main-navbar">
    <div class="header-right">
        <a href="dashboard.html" class="logo-con">
            <img src="{{ asset('admin-assets/assets/images/logo.png') }}" class="img-responsive center-block" alt="لوگو قالب مدیران">
        </a>
    </div><!-- /.header-right -->
            ...
            <ul class="nav navbar-nav navbar-left">
                                    ...
                                    <a href="#">
                                        <p class="clearfix">
                                            <strong class="float-start">
                                                <img src="assets/images/user/32.png" class="img-circle" alt="">
                                                سهراب سپهری
                                            </strong>
                ...
                <li class="dropdown dropdown-user">
                    <a href="#" class="dropdown-toggle dropdown-hover" data-bs-toggle="dropdown">
                        <img src="{{ asset('admin-assets/assets/images/user/48.png') }}" alt="عکس پرفایل" class="img-circle img-responsive">
