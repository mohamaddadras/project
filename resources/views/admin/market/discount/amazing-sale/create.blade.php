...
@section('head-tag')
    ...
    <title>داشبورد | ایجاد فروش شگفت انگیز جدید</title>
    @endsection
@section('content')
    <!-- BEGIN BREADCRUMB -->
    <div class="col-md-12">
        <div class="breadcrumb-box shadow">
            <ul class="breadcrumb">
                ...
                <li><a href="{{ route('admin.market.discount.amazing-sale.index') }}">فروش شگفت انگیز</a></li>
                <li class="active">ایجاد فروش شگفت انگیز جدید</li>
            </ul>
            ...
            <div class="portlet-heading">
                <div class="portlet-title">
                    <h3 class="title">                                        
                        ...
                        فرم ایجاد فروش شگفت انگیز جدید
                    </h3>
                </div><!-- /.portlet-title -->
            ...
            <div class="portlet-body">
                <form role="form">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('admin.market.discount.amazing-sale.index') }}" class="btn btn-warning btn-round ladda-button" data-style="expand-right">
                            بازگشت
