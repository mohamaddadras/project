...
@section('head-tag')
    ...
    <title>داشبورد | کپن های تخفیف</title>
@endsection
@section('content')
    <!-- BEGIN BREADCRUMB -->
    <div class="col-md-12">
        <div class="breadcrumb-box shadow">
            <ul class="breadcrumb">
                ...
                <li class="active">کپن های تخفیف</li>
            </ul>
    ...
    <div class="col-md-12">
        <div class="portlet box shadow curve">
            ...
            <div class="portlet-body">
                <a href="{{ route('admin.market.discount.copan.create') }}" class="btn btn-success btn-round w-100 ladda-button"
                    data-style="slide-up">
                    <i class="fa fa-plus"></i> ایجاد کپن تخفیف جدید
                </a>
            </div>
        </div>
    </div>
        ...
        <table class="table table-bordered table-hover table-striped" id="data-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>100000 تومان</td>
                    <td>
                        <label class="label-info round">عمومی</label>
                        <label class="label-secondary round">خصوصی</label>
                    </td>
                    <td>25 خرداد 1402</td>
                    <td>1 تیر 1402</td>
                    <td>
