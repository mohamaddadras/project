...
@section('head-tag')
    ...
    <title>داشبورد | ایجاد کپن تخفیف جدید</title>
@endsection
@section('content')
    <!-- BEGIN BREADCRUMB -->
    <div class="col-md-12">
        <div class="breadcrumb-box shadow">
            <ul class="breadcrumb">
                ...
                <li><a href="{{ route('admin.market.discount.copan.index') }}">کپن های تخفیف</a></li>
                <li class="active">ایجاد کپن تخفیف جدید</li>
            </ul>
            ...
            <div class="portlet-body">
                <form role="form">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('admin.market.discount.copan.index') }}" class="btn btn-warning btn-round ladda-button" data-style="expand-right">
                            بازگشت
