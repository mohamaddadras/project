...
@section('head-tag')
    ...
    <title>داشبورد | روش های ارسال</title>
@endsection
@section('content')
    <!-- BEGIN BREADCRUMB -->
    <div class="col-md-12">
        <div class="breadcrumb-box shadow">
            <ul class="breadcrumb">
                ...
                <li class="active">روش های ارسال</li>
            </ul>
    ...
    <div class="col-md-12">
        <div class="portlet box shadow curve">
            ...
            <div class="portlet-body">
                <a href="{{ route('admin.market.delivery.create') }}" class="btn btn-success btn-round w-100 ladda-button"
                    data-style="slide-up">
                    <i class="fa fa-plus"></i> ایجاد روش ارسال جدید
                </a>
            </div>
        </div>
    </div>
