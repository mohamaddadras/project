    ...
    <div class="col-md-12">
        <div class="portlet box shadow curve">
            ...
            <div class="portlet-body">
                <a href="{{ route('admin.market.brand.create') }}" class="btn btn-success btn-round w-100 ladda-button"
                    data-style="slide-up">
                    <i class="fa fa-plus"></i> ایجاد برند جدید
                </a>
            </div>
        </div>
    </div>
