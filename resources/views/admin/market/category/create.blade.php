...
@section('head-tag')
    ...
    <title>داشبورد | ایجاد دسته بندی جدید</title>
@endsection
@section('content')
    <!-- BEGIN BREADCRUMB -->
    <div class="col-md-12">
        <div class="breadcrumb-box shadow">
            <ul class="breadcrumb">
                ...
                <li><a href="{{ route('admin.market.category.index') }}">دسته بندی ها</a></li>
            ...
            <div class="portlet-body">
                <form role="form">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('admin.market.category.index') }}" class="btn btn-warning btn-round ladda-button" data-style="expand-right">
                            بازگشت
